...
void my_handler(int signo,siginfo_t *si,void *ucontext){
    ...
    if(signo==SIGUSR2){
        ...
        sigqueue(getppid(),SIGUSR2,val); //сигналов, отправленных с помощью вызова
...
int main(int argc,char** argv){
    printf("Hello, world!\n");
    struct sigaction act; //изменяет поведение сигнала, указанного при помощи аргумента signo.
